 ...
 * Description: <br>
 * 
 * @author Adm/OpMgr/Dgnr, syoon827
...
public class job1 implements TalendJob {
	...
	private final String projectName = "ADMINLABS";
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_ADMINLABS_job1 = new byte[0];
		static byte[] commonByteArray_ADMINLABS_job1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ADMINLABS_job1.length) {
					if (length < 1024 && commonByteArray_ADMINLABS_job1.length == 0) {
						commonByteArray_ADMINLABS_job1 = new byte[1024];
					} else {
						commonByteArray_ADMINLABS_job1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ADMINLABS_job1, 0, length);
				strReturn = new String(commonByteArray_ADMINLABS_job1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_ADMINLABS_job1, 0, length);
				strReturn = new String(commonByteArray_ADMINLABS_job1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ADMINLABS_job1) {
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_cj2nkInUEe-3q8JZmimLsQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-10-14T02:34:42.744980Z");
		...
		try {
			...
			java.io.InputStream inContext = job1.class.getClassLoader()
					.getResourceAsStream("adminlabs/job1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 67290 characters generated by Talend Real-time Big Data Platform on the
 * October 14, 2024 at 11:34:43 AM KST
 ************************************************************************************************/