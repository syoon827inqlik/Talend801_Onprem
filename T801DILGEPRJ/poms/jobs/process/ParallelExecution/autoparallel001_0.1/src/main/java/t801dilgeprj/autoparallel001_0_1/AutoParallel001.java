...
package t801dilgeprj.autoparallel001_0_1;
...
/**
 * Job: AutoParallel001 Purpose: <br>
 * Description: <br>
 * 
 * @author YOON, SEAN
 ...
 * @status
 */
public class AutoParallel001 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "AutoParallel001.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(AutoParallel001.class);
	...
	private final String jobName = "AutoParallel001";
	private final String projectName = "T801DILGEPRJ";
	...
	private class TalendException extends Exception {
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TalendException)) {
				AutoParallel001.this.exception = e;
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(AutoParallel001.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_T801DILGEPRJ_AutoParallel001 = new byte[0];
		static byte[] commonByteArray_T801DILGEPRJ_AutoParallel001 = new byte[0];
		...
		public Boolean Thread_IDIsNullable() {
			return true;
		}

		public Boolean Thread_IDIsKey() {
			return false;
		}

		public Integer Thread_IDLength() {
			return null;
		}

		public Integer Thread_IDPrecision() {
			return null;
		}

		public String Thread_IDDefault() {

			return null;

		}

		public String Thread_IDComment() {

			return "";

		}

		public String Thread_IDPattern() {

			return "";

		}

		public String Thread_IDOriginalDbColumnName() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_T801DILGEPRJ_AutoParallel001.length) {
					if (length < 1024 && commonByteArray_T801DILGEPRJ_AutoParallel001.length == 0) {
						commonByteArray_T801DILGEPRJ_AutoParallel001 = new byte[1024];
					} else {
						commonByteArray_T801DILGEPRJ_AutoParallel001 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_T801DILGEPRJ_AutoParallel001, 0, length);
				strReturn = new String(commonByteArray_T801DILGEPRJ_AutoParallel001, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_T801DILGEPRJ_AutoParallel001, 0, length);
				strReturn = new String(commonByteArray_T801DILGEPRJ_AutoParallel001, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_T801DILGEPRJ_AutoParallel001) {
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.Thread_ID, dos);
	...
	public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_2.addRow(new String[] { "Id", "FirstName", "LastName", "Thread_ID", });
...
///////////////////////    			
				...
				util_tLogRow_1.addRow(new String[] { "Id", "FirstName", "LastName", "Thread_ID", });
...
// ###############################
				...
				class tRowGenerator_1Randomizer {
					...
					public String getRandomLastName() {
						...
						String[] LastNameTable = new String[] { "Smith", "Thomson", "Willis", "Higgins", "Harris" };
						java.util.Random randomtRowGenerator_1 = new java.util.Random();
						return LastNameTable[randomtRowGenerator_1.nextInt(LastNameTable.length)];
...
// # Output table : 'out'
						...
						out_tmp.Id = row1.Id;
						out_tmp.FirstName = row1.FirstName;
						out_tmp.LastName = row1.LastName;
						out_tmp.Thread_ID = Thread.currentThread().getName();
						out = out_tmp;
...
///////////////////////		
						...
						if (out.Id != null) { //
							row_tLogRow_1[0] = String.valueOf(out.Id);

						} //

						if (out.FirstName != null) { //
							row_tLogRow_1[1] = String.valueOf(out.FirstName);

						} //

						if (out.LastName != null) { //
							row_tLogRow_1[2] = String.valueOf(out.LastName);

						} //

						if (out.Thread_ID != null) { //
							row_tLogRow_1[3] = String.valueOf(out.Thread_ID);
...
///////////////////////    			
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tLogRow_1", "tLogRow_1", "tLogRow", "tLogRow_2", "tLogRow_2", "tLogRow"
...
///////////////////////		
						...
						if (row2.FirstName != null) { //
							row_tLogRow_2[1] = String.valueOf(row2.FirstName);

						} //

						if (row2.LastName != null) { //
							row_tLogRow_2[2] = String.valueOf(row2.LastName);

						} //

						if (row2.Thread_ID != null) { //
							row_tLogRow_2[3] = String.valueOf(row2.Thread_ID);
...
///////////////////////    			
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tLogRow_1", "tLogRow_1", "tLogRow", "tLogRow_2", "tLogRow_2", "tLogRow", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public static void main(String[] args) {
		final AutoParallel001 AutoParallel001Class = new AutoParallel001();

		int exitCode = AutoParallel001Class.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'AutoParallel001' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'AutoParallel001' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_XpmBHI1KEfC1Xa5SZ82j_Q");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2025-09-09T07:24:55.379952900Z");
		...
		try {
			...
			java.io.InputStream inContext = AutoParallel001.class.getClassLoader()
					.getResourceAsStream("t801dilgeprj/autoparallel001_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = AutoParallel001.class.getClassLoader()
		...
		log.info("TalendJob: 'AutoParallel001' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : AutoParallel001");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'AutoParallel001' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 111020 characters generated by Talend Real-time Big Data Platform on the
 * September 9, 2025 at 4:24:55 PM KST
 ************************************************************************************************/