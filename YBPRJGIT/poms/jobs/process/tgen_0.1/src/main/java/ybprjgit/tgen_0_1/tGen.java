...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_bojakPAqEe-LXeArAikIEA", "0.1");
...
public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "kFCbtp_" + subJobPidCounter.getAndIncrement());
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
			...
			log.info("TalendJob: 'tGen' - Start.");
                ...
                org.slf4j.MDC.put("_jobRepositoryId","_bojakPAqEe-LXeArAikIEA");
                org.slf4j.MDC.put("_compiledAtTimestamp","2025-02-21T08:05:24.812848200Z");
...
/************************************************************************************************
 *     58408 characters generated by Talend Real-time Big Data Platform 
 *     on the 2025년 2월 21일 오후 5시 5분 24초 KST
 ************************************************************************************************/